...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _videosRepository = VideosRepository(getDatabase(application))
    val videosRepository get() = _videosRepository
    /**
    ...
    val playlist = _videosRepository.videos
    /**
    ...
    private fun refreshDataFromRepository() {
        viewModelScope.launch {
            try {
                _videosRepository.refreshVideos()
